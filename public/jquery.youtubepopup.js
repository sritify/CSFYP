			...
			return this.each(function () {
				...
				if (!data) { //check if event is already assigned
					...
					$(obj).bind('click.YouTubePopup', function () {
						...
						if ($.trim(youtubeId) == '' && obj.is("button")) {
							youtubeId = getYouTubeIdFromUrl(obj.attr("title"));
						}
						...
						YouTubeDialog.html('<div id="player"></div>');//getYouTubePlayer(YouTubeURL, options.width, options.height));
